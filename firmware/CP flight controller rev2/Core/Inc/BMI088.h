...
#define BMI088_CHIP_SELECT_ACCEL(BMI088)		LL_GPIO_ResetOutputPin(nCS_BMI088_ACCEL_GPIO_Port, nCS_BMI088_ACCEL_Pin)
#define BMI088_CHIP_DESELECT_ACCEL(BMI088)		LL_GPIO_SetOutputPin(  nCS_BMI088_ACCEL_GPIO_Port, nCS_BMI088_ACCEL_Pin)
#define BMI088_CHIP_SELECT_GYRO(BMI088)			LL_GPIO_ResetOutputPin(nCS_BMI088_GYRO_GPIO_Port,  nCS_BMI088_GYRO_Pin)
#define BMI088_CHIP_DESELECT_GYRO(BMI088)		LL_GPIO_SetOutputPin(  nCS_BMI088_GYRO_GPIO_Port,  nCS_BMI088_GYRO_Pin)
