...
#define MS5611_CHIP_SELECT(MS5611)		LL_GPIO_ResetOutputPin(nCS_MS5611_GPIO_Port, nCS_MS5611_Pin)
#define MS5611_CHIP_DESELECT(MS5611)	LL_GPIO_SetOutputPin(  nCS_MS5611_GPIO_Port, nCS_MS5611_Pin)
